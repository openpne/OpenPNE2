...
({* #1931 *})<td style="width:528px;padding:2px 0px;" class="bg_06"><span class="b_b c_00">このコミュニティに参加</span></td>
({* #1931 *})</tr>
({* #1931 *})</table>
({* #1931 *})<!-- ここまで：小タイトル -->
({* #1931 *})({*ここまで：header*})
({* #1931 *})({*ここから：body*})
({* #1931 *})<!-- ここから：メッセージ -->
({* #1931 *})<table border="0" cellspacing="1" cellpadding="3" style="width:564px;">
({* #1931 *})<tr>
({* #1931 *})<td colspan="2" class="bg_02" align="center">
({* #1931 *})
({* #1931 *})<table><tr><td colspan="2">
({* #1931 *})<table><tr><td colspan="2">
({* #1931 *})({$c_commu.name|default:"&nbsp;"})に本当に参加しますか?
({* #1931 *})</td></tr>
({* #1931 *})
({* #1931 *})<tr>
({* #1931 *})
({* #1931 *})({t_form_block m=pc a=do_inc_join_c_commu})
({* #1931 *})
({* #1931 *})<input type="hidden" name="target_c_commu_id" value="({$c_commu.c_commu_id})">
({* #1931 *})<td align="right"><input type="submit" class="input_submit" value="参加する"></td>
({* #1931 *})({/t_form_block})
({* #1931 *})
({* #1931 *})({t_form_block _method=get m=pc a=page_c_home})
({* #1931 *})<input type="hidden" name="target_c_commu_id" value="({$c_commu.c_commu_id})">
({* #1931 *})<td align="left"><input type="submit" class="input_submit" value="参加しない"></td>
({* #1931 *})({/t_form_block})
({* #1931 *})</tr></table>
({* #1931 *})</td></tr>
({* #1931 *})
