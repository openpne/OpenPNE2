...
({* #1952 *})<!-- ******ここから：メールアドレス変更****** -->
({* #1952 *})({t_form_block m=pc a=do_o_regist_mail})
...
({* #1952 *})<td style="width:458px;padding:2px 0px;" class="bg_06"><span class="b_b c_00">メールアドレス登録</span></td>
...
({* #1952 *})
({* #1952 *})({$pc_address})<br />
({* #1952 *})<span class="caution">※メールアドレスは公開されません。</span>
({* #1952 *})
({* #1952 *})</div>
({* #1952 *})</td>
({* #1952 *})<td style="width:1px;" class="bg_01" align="center"><img src="./skin/dummy.gif" alt="dot" class="dot" /></td>
...
({* #1952 *})<div class="padding_w_m">
({* #1952 *})
({* #1952 *})<input type="submit" class="input_submit" value="　変　更　">
({* #1952 *})
({* #1952 *})</div>
({* #1952 *})
({* #1952 *})</td>
