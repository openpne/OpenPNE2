...
({* #1931 *})<!-- *ここから：スケジュール削除確認内容* -->
({* #1931 *})({*ここから：header*})
({* #1931 *})<!-- ここから：小タイトル -->
({* #1931 *})<table border="0" cellspacing="0" align="center" cellpadding="0" style="width:566px;" class="border_01">
({* #1931 *})<tr><td class="bg_06"><img src="({t_img_url_skin filename=content_header_1})" style="width: 30px;height: 20px;" class="dummy" align="left"><div class="b_b c_00" style="padding:3px 0px;">この予定を削除してよろしいですか？</div></td></tr>
({* #1931 *})</table>
({* #1931 *})<!-- ここまで：小タイトル -->
({* #1931 *})({*ここまで：header*})
({* #1931 *})({*ここから：body*})
...
({* #1931 *})({*********})
({* #1931 *})<!-- *ここまで：スケジュール詳細* -->
({* #1931 *})<!-- *ここから：削除・キャンセルボタン* -->
({* #1931 *})<tr>
({* #1931 *})<td class="bg_03" align="center" colspan="2">
({* #1931 *})
({* #1931 *})<div class="padding_w_m">
({* #1931 *})
({* #1931 *})<table border="0" cellspacing="0" cellpadding="6" style="width:200px;">
({* #1931 *})<tr>
({* #1931 *})<td>
({* #1931 *})
({* #1931 *})({t_form_block m=pc a=do_h_schedule_delete_delete_c_schedule})
...
({* #1931 *})<td>
({* #1931 *})
({* #1931 *})({t_form_block _method=get m=pc a=page_h_schedule})
({* #1931 *})<input type="hidden" name="target_c_schedule_id" value="({$c_schedule.c_schedule_id})">
