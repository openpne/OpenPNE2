...
<tr>
<td style="width:7px;" class="bg_00"><img src="./skin/dummy.gif" alt="dummy" class="dummy"></td>
<td style="width:636px;" class="bg_00"><img src="./skin/dummy.gif" alt="dummy" class="dummy"></td>
<td style="width:7px;" class="bg_00"><img src="./skin/dummy.gif" alt="dummy" class="dummy"></td>
</tr>
<tr>
