...
({* #1931 *})<!-- *ここから：スケジュール修正内容確認内容* -->
({* #1931 *})({*ここから：header*})
({* #1931 *})<!-- ここから：小タイトル -->
({* #1931 *})<table border="0" cellspacing="0" align="center" cellpadding="0" style="width:566px;" class="border_01">
({* #1931 *})<tr>
({* #1931 *})<td class="bg_06"><img src="({t_img_url_skin filename=content_header_1})" style="width: 30px;height: 20px;" class="dummy" align="left"><div class="b_b c_00" style="padding:3px 0px;">以下の内容でよろしいですか？</div></td>
({* #1931 *})</tr>
({* #1931 *})</table>
({* #1931 *})<!-- ここまで：小タイトル -->
({* #1931 *})({*ここまで：header*})
...
({* #1931 *})<!-- *ここから：編集・修正ボタン* -->
({* #1931 *})<tr>
({* #1931 *})<td class="bg_03" align="center" colspan="2">
({* #1931 *})
({* #1931 *})<div class="padding_w_m">
({* #1931 *})
({* #1931 *})<table border="0" cellspacing="0" cellpadding="6">
({* #1931 *})<tr>
({* #1931 *})<td>
({* #1931 *})
({* #1931 *})({t_form_block m=pc a=do_h_schedule_edit_update_c_schedule})
({* #1931 *})
({* #1931 *})<input type="hidden" name="target_c_schedule_id" value="({$target_c_schedule_id})">
...
({* #1931 *})<td><input type="submit" class="input_submit" value="　 完　　了 　">
({* #1931 *})({/t_form_block})
({* #1931 *})
({* #1931 *})</td>
({* #1931 *})<td>
...
({* #1931 *})<input type="hidden" name="end_minute" value="({$input.end_minute})">
({* #1931 *})<input type="hidden" name="is_receive_mail" value="({$input.is_receive_mail})">
({* #1931 *})<td><input type="submit" class="input_submit" value="　 修　　正 　"><br>
({* #1931 *})({/t_form_block})
({* #1931 *})
({* #1931 *})</td>
({* #1931 *})</tr>
