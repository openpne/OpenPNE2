...
({* unknown *})<td style="width:636px;" class="bg_00"><img src="./skin/dummy.gif" alt="dummy" style="width:566px;height:7px;" class="dummy" /></td>
({* unknown *})<td style="width:7px;" class="bg_00"><img src="./skin/dummy.gif" alt="square" class="square" /></td>
({* unknown *})</tr>
({* unknown *})<tr>
...
({* unknown *})<td style="width:598px;padding:2px 0px;" class="bg_06"><span class="b_b c_00">レビュー</span></td>
({* unknown *})</tr>
({* unknown *})</table>
({* unknown *})<!-- ここまで：小タイトル -->
({* unknown *})({*ここまで：header*})
...
({* unknown *})
({* unknown *})</td>
({* unknown *})<td style="width:1px;" rowspan="7"><img src="./skin/dummy.gif" alt="dot" class="dot" /></td>
...
({* unknown *})</td>
({* unknown *})<td style="width:1px;" class="bg_01" align="center"><img src="./skin/dummy.gif" alt="dot" class="dot" /></td>
({* unknown *})<td style="width:352px;" class="bg_02" align="left" valign="middle">
({* unknown *})
({* unknown *})<div class="padding_s">
({* unknown *})
({* unknown *})({$c_review_comment.title})
({* unknown *})
({* unknown *})</div>
({* unknown *})
({* unknown *})</td>
...
({* unknown *})<div class="padding_s">
({* unknown *})
({* unknown *})<textarea name="body" rows="10" cols="45">({$c_review_comment.body})</textarea>
({* unknown *})
({* unknown *})</div>
({* unknown *})
({* unknown *})</td>
...
({* unknown *})({html_options options=$satisfaction selected=$c_review_comment.satisfaction_level})
({* unknown *})</select>
({* unknown *})
({* unknown *})</div>
({* unknown *})
...
({* unknown *})<tr>
({* unknown *})<td class="bg_01" align="center"><img src="./skin/dummy.gif" alt="dot" class="dot" /></td>
({* unknown *})<td class="bg_03" align="left" valign="middle" colspan="6">
({* unknown *})
