...
({* #1952 *})<td style="width:458px;padding:2px 0px;" class="bg_06"><span class="b_b c_00">PCメールアドレス登録</span></td>
...
({* #1952 *})
({* #1952 *})PCメールアドレスの登録をおこないます。<br />
({* #1952 *})パスワードを入力してください。<br />
({* #1952 *})※既にPCメールアドレスが登録されている場合、新しいメールアドレスに変更されます。
({* #1952 *})
({* #1952 *})</div>
({* #1952 *})
({* #1952 *})</td>
