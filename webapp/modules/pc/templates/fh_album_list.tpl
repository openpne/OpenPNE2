...
({* unknown *})({if $is_prev})
({* unknown *})<p class="prev"><a href="({t_url m=pc a=page_fh_album_list})&amp;page=({$page-1})&amp;target_c_member_id=({$target_member.c_member_id})({if $url_keyword})&amp;keyword=({$url_keyword})({/if})">前を表示</a></p>
({* unknown *})({/if})
...
({* unknown *})</p>
({* unknown *})({if $is_next})
({* unknown *})<p class="next"><a href="({t_url m=pc a=page_fh_album_list})&amp;page=({$page+1})&amp;target_c_member_id=({$target_member.c_member_id})({if $url_keyword})&amp;keyword=({$url_keyword})({/if})">次を表示</a></p>
({* unknown *})({/if})
({* unknown *})</div>
