...
({if !$all})
<p>({$date_val.year})年({$date_val.month})月({if $date_val.day})({$date_val.day})日({/if})</p>
({/if})
</div>
...
<tr>
<th class="icon"></th>
<th class="check">削除</th>
<th class="name">送信者</th>
...
({/if})
({/strip})</td>
<td class="check"><input name="c_message_id[]" value="({$c_message_ru.c_message_id})" type="checkbox" class="no_bg" /></td>
<td class="name">({$c_message_ru.nickname})</td>
<td class="subject"><a href="({t_url m=pc a=page_h_message})&amp;target_c_message_id=({$c_message_ru.c_message_id})&amp;jyusin_c_message_id=({$c_message_ru.c_message_id})">({$c_message_ru.subject})</a></td>
<td class="date">({$c_message_ru.r_datetime|date_format:"%m月%d日"})</td>
</tr>
({/foreach})
</table>
...
<div class="partsInfo">
<p><img src="({t_img_url_skin filename=icon_mail_1})" alt="未読" /> … 未読
 <img src="({t_img_url_skin filename=icon_mail_2})" alt="既読" /> … 既読
 <img src="({t_img_url_skin filename=icon_mail_4})" alt="返信済み" /> … 返信済み</p>
</div>
</div></div>
({* }}} *})
({else})
...
<tr>
<td class="icon"><img src="({t_img_url_skin filename=icon_mail_3})" alt="" /></td>
<td class="check"><input name="c_message_id[]" value="({$c_message_s.c_message_id})" type="checkbox" class="no_bg" /></td>
<td class="name">({$c_message_s.nickname})</td>
<td class="subject"><a href="({t_url m=pc a=page_h_message})&amp;target_c_message_id=({$c_message_s.c_message_id})&amp;box=outbox">({$c_message_s.subject})</a></td>
<td class="date">({$c_message_s.r_datetime|date_format:"%m月%d日"})</td>
</tr>
({/foreach})
</table>
...
<tr>
<td class="icon"><img src="({t_img_url_skin filename=icon_mail_1})" alt="" /></td>
<td class="check"><input name="c_message_id[]" value="({$c_message_save.c_message_id})" type="checkbox" class="no_bg" /></td>
<td class="name">({$c_message_save.nickname})</td>
<td class="subject"><a href="({t_url m=pc a=page_f_message_send})&amp;target_c_message_id=({$c_message_save.c_message_id})&amp;jyusin_c_message_id=({$c_message_save.hensinmoto_c_message_id})&amp;box=savebox">({$c_message_save.subject})</a></td>
<td class="date">({$c_message_save.r_datetime|date_format:"%m月%d日"})</td>
</tr>
({/foreach})
</table>
...
({/if})
({/strip})</td>
<td class="check"><input name="c_message_id[]" value="({$c_message_trash.c_message_id})" type="checkbox" /></td>
<td class="name">({$c_message_trash.nickname})</td>
<td class="subject"><a href="({t_url m=pc a=page_h_message})&amp;target_c_message_id=({$c_message_trash.c_message_id})&amp;box=trash">({$c_message_trash.subject})</a></td>
<td class="date">({$c_message_trash.r_datetime|date_format:"%m月%d日"})</td>
</tr>
({/foreach})
</table>
...
<div class="operation">
<p><a href="#" onclick="return checkAll();" onkeypress="return checkAll();">全てをチェック</a> / <a href="#" onclick="return clearAll();" onkeypress="return clearAll();">全てのチェックをはずす</a></p>
<p><input type="submit" class="input_submit" name="move" value="元に戻す" />
 <input type="submit" class="input_submit" name="remove" value="削除" /></p>
</div>

({/t_form_block})

<div class="partsInfo">
<p><img src="({t_img_url_skin filename=icon_mail_2})" alt="受信" /> … 受信
 <img src="({t_img_url_skin filename=icon_mail_3})" alt="送信済み" /> … 送信済み
 <img src="({t_img_url_skin filename=icon_mail_1})" alt="下書き" /> … 下書き</p>
</div>
</div></div>
({* }}} *})
({else})
