...
<table border="0" cellspacing="0" cellpadding="0" style="width:624px;" class="border_11">
    <tr>
        <td style="width:624px;height:1px;" class="bg_01" colspan="5"><img src="./skin/dummy.gif" style="width:1px;height:1px;" class="dummy"></td>
    </tr>
    <tr>
...
<div class="padding_s">({$ltag.album_cover})</div>
</td>
<td class="bg_01" align="center"><img src="./skin/dummy.gif" style="width:1px;height:1px;" class="dummy"></td>
<td class="bg_02" align="left" valign="middle">
<div class="padding_s">
...
<td class="bg_01" align="center"><img src="./skin/dummy.gif" style="width:1px;height:1px;" class="dummy"></td>
<td class="bg_02" align="left" valign="middle">
<div class="padding_s">({$ltag.group_blog})</div>
</td>
<td class="bg_01" align="center"><img src="./skin/dummy.gif" style="width:1px;height:1px;" class="dummy"></td>
<td class="bg_02" align="left" valign="middle">
<div class="padding_s">
...
({$ltag.ablum_face})({$WORD_MY_FRIEND})({$ltag.ablum_op})
...
<tr>
    ...
    <div class="padding_w_m">
        ...
        <tr>
        ({t_form m=pc a=do_h_album_add_insert_c_album})
        <input type="hidden" name="sessid" value="({$PHPSESSID})">
        <input type="hidden" name="subject" value="({$form_val.subject})">
        <input type="hidden" name="description" value="({$form_val.description})">
        <input type="hidden" name="is_shown" value="({$form_val.is_shown})">
        <input type="hidden" name="public_flag" value="({$form_val.public_flag})">
        <input type="hidden" name="tmpfile_1" value="({$form_val.tmpfile_1})">
        ...
        <td class="padding_s"><input type="submit" class="submit" value="({$ltag.released_2})"></td>
        </form>
        ({t_form m=pc a=page_h_album_add})
        <input type="hidden" name="subject" value="({$form_val.subject})">
        <input type="hidden" name="description" value="({$form_val.description})">
        <input type="hidden" name="public_flag" value="({$form_val.public_flag})">
        <input type="hidden" name="category" value="({$form_val.category})">
