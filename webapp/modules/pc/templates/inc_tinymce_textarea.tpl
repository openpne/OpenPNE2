...
<a id="mce_textmode_button_op_image" href="javascript:;" onclick="window.open('({t_url m=pc a=page_h_album_insert_dialog})', '', 'width=600,height=550,toolbar=no,scrollbars=yes,left=10,top=10')"><img src="({t_img_url_skin filename=deco_op_image})" alt="" /></a>
({/if})
({if $smarty.const.OPENPNE_EMOJI_DOCOMO_FOR_PC})
<a id="mce_textmode_button_op_emoji_docomo" href="javascript:;" onclick="togglePallet('epDocomo');"><img src="({t_img_url_skin filename=deco_op_emoji_docomo})" alt="" /></a>
({else})
<a id="mce_textmode_button_op_emoji_docomo" href="javascript:;" onclick="togglePallet('epDocomo');"><img src="({t_img_url_skin filename=deco_op_emoji_docomo})" alt="" /></a>
<a id="mce_textmode_button_op_emoji_au" href="javascript:;" onclick="togglePallet('epAu');"><img src="({t_img_url_skin filename=deco_op_emoji_au})" alt="" /></a>
<a id="mce_textmode_button_op_emoji_softbank" href="javascript:;" onclick="togglePallet('epSb');"><img src="({t_img_url_skin filename=deco_op_emoji_softbank})" alt="" /></a>
({/if})
({if $smarty.const.OPENPNE_DECORATION_CMD_URL})
<a id="mce_textmode_button_op_cmd" href="javascript:;" style="margin-left:20px;" onclick="window.open('({$smarty.const.OPENPNE_DECORATION_CMD_URL})')"><img src="({t_img_url_skin filename=deco_op_cmd})" alt="" /></a>
({/if})
