...
({* #1952 *})<!-- ******ここから：副管理者要請****** -->
({* #1952 *})
({* #1952 *})({t_form_block m=pc a=page_c_sub_admin_request_confirm})
({* #1952 *})
...
({* #1952 *})<td style="width:528px;padding:2px 0px;" class="bg_06"><span class="b_b c_00">副管理者要請</span></td>
({* #1952 *})</tr>
({* #1952 *})</table>
({* #1952 *})<!-- ここまで：小タイトル -->
({* #1952 *})({*ここまで：header*})
...
({* #1952 *})
({* #1952 *})({$member.nickname})さんに副管理者要請メッセージを送信します。
({* #1952 *})
({* #1952 *})</div>
({* #1952 *})
({* #1952 *})</td>
...
({* #1952 *})<div class="padding_s">
({* #1952 *})
({* #1952 *})<a href="({t_url m=pc a=page_f_home})&amp;target_c_member_id=({$member.c_member_id})">({$member.nickname})</a>
({* #1952 *})
({* #1952 *})</div>
({* #1952 *})
({* #1952 *})</td>
...
({* #1952 *})<div class="padding_s">
({* #1952 *})
({* #1952 *})<textarea name="body" rows="5" cols="50">({$body})</textarea>
({* #1952 *})
({* #1952 *})</div>
({* #1952 *})
({* #1952 *})</td>
