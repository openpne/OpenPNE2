...
<div class="partsHeading"><h3>副管理者要請</h3></div>

({t_form_block m=pc a=page_c_sub_admin_request_confirm})
<input type="hidden" name="target_c_member_id" value="({$member.c_member_id})" />
<input type="hidden" name="target_c_commu_id" value="({$c_commu.c_commu_id})" />

<div class="partsInfo">
<p>({$member.nickname})さんに副管理者要請メッセージを送信します。</p>
</div>
...
<tr><th>メッセージ (任意)</th><td><textarea name="body" rows="5" cols="50">({$body})</textarea></td></tr>
</table>
