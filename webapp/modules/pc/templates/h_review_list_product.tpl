...
({if $is_prev})<p class="prev"><a href="({t_url m=pc a=page_h_review_list_product})&amp;c_review_id=({$c_review.c_review_id})&amp;direc=-1&amp;page=({$page})">前を表示</a></p>({/if})
<p class="number">({$start_num})件～({$end_num})件を表示</p>
({if $is_next})<p class="next"><a href="({t_url m=pc a=page_h_review_list_product})&amp;c_review_id=({$c_review.c_review_id})&amp;direc=1&amp;page=({$page})">次を表示</a></p>({/if})
</div>
