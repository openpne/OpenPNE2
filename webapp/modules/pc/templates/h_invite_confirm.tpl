...
({* #1952 *})<td style="width:398px;padding:2px 0px;" class="bg_06"><span class="b_b c_00">友人を({$SNS_NAME})に招待する</span></td>
...
({* #1952 *})<td style="width:150px;" class="bg_09" align="left" valign="middle">
({* #1952 *})
...
({* #1952 *})
({* #1952 *})<div style="padding:6px 0px;">
({* #1952 *})
({* #1952 *})<table border="0" cellspacing="0" cellpadding="0" style="width:100%">
({* #1952 *})<tr>
({* #1952 *})<td style="width:50%;height:2em;text-align:right;">
({* #1952 *})
