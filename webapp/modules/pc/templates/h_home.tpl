...
<tr>
<td style="width:5px;"><img src="./skin/dummy.gif" alt="" style="width:5px;height:1px;" class="dummy"></td>
...
<tr>
<td class="bg_07"><img src="./skin/dummy.gif" alt="" style="width:1px;"></td>
...
<td style="width:5px;" class="bg_02" rowspan="2"><img src="./skin/dummy.gif" alt="" style="width:5px;height:1px;" class="dummy"></td>
</tr>
<tr>
<td style="width:20px;" class="bg_02"><img src="./skin/dummy.gif" alt="" class="icon arrow_1"></td>
<td align="left" style="width:116px;padding:2px 0px;" class="bg_02 lh_110">
...
<td style="width:200px;padding:2px 0px;" class="bg_09"><span class="b_b c_00">({if $c_member_all.profile.PNE_MESSAGE_DATETIME.value})({$c_member_all.profile.PNE_MESSAGE_DATETIME.value|date_format:"%m/%d %H:%M"}) 更新({/if}) </span></td>
<td style="width:186px;" align="right" class="bg_09">&nbsp;</td>
</tr>
</table>
</div>
<div class="border_01 bg_02 padding_s" align="left">
({t_form m=pc a=do_h_home_update_message})
<input type="hidden" name="sessid" value="({$PHPSESSID})">

<textarea style="WIDTH: 350px" name="prof_message" rows="3">({$c_member_all.profile.PNE_MESSAGE.value})</textarea>
<INPUT style="PADDING-RIGHT: 0px; PADDING-LEFT: 0px; PADDING-BOTTOM: 11px; PADDING-TOP: 11px; TEXT-ALIGN: center; 6px: " type=submit value=&nbsp;変&nbsp;更&nbsp;> 
...
<img src="./skin/dummy.gif" alt="" style="width:14px;height:14px;clear:both;" class="icon icon_1">({$item.r_datetime|date_format:"%m月%d日"})…&nbsp;<a href="({t_url m=pc a=page_fh_diary})&amp;target_c_diary_id=({$item.c_diary_id})&amp;comment_count=({$item.count_comments})">({$item.subject|default:"&nbsp;"}) (({$item.count_comments|default:0}))</a>
...
<img src="./skin/dummy.gif" alt="" style="width:14px;height:14px;" class="icon icon_1">({$item.r_datetime|date_format:"%m月%d日"})…&nbsp;<a href="({$item.link})" target="_blank">({$item.subject|default:"&nbsp;"})</a>
...
<img src="./skin/dummy.gif" alt="" style="width:14px;height:14px;" class="icon icon_3">({$item.r_datetime|date_format:"%m月%d日"})…&nbsp;<a href="({t_url m=pc a=page_fh_diary})&amp;target_c_diary_id=({$item.c_diary_id})&amp;comment_count=({$item.num_comment})">({$item.subject}) (({$item.num_comment}))</a>
(({$item.nickname}))<br>
({/foreach})
...
<img src="./skin/dummy.gif" alt="" style="width:14px;height:14px;" class="icon icon_2">({$item.r_datetime|date_format:"%m月%d日"})…&nbsp;<a href="({t_url m=pc a=page_c_topic_detail})&amp;target_c_commu_topic_id=({$item.c_commu_topic_id})&amp;comment_count=({$item.number})">({$item.c_commu_topic_name}) (({$item.number}))</a>
(({$item.c_commu_name}))
...
<img src="./skin/dummy.gif" alt="" style="width:14px;height:14px;" class="icon icon_1">({$item.r_datetime|date_format:"%m月%d日"})…&nbsp;<a href="({t_url m=pc a=page_h_review_list_product})&amp;c_review_id=({$item.c_review_id})">({$item.title|t_truncate:30})</a>
(({$item.nickname}))<br>
({/foreach})
...
<img src="./skin/dummy.gif" alt="" style="width:14px;height:14px;" class="icon icon_1">({$item.r_datetime|date_format:"%m月%d日"})…&nbsp;<a href="({t_url m=pc a=page_fh_diary})&amp;target_c_diary_id=({$item.c_diary_id})&amp;comment_count=({$item.count_comments})">({$item.subject|default:"&nbsp;"}) (({$item.count_comments}))</a>
(({$item.nickname}))
({if $item.image_filename_1 || $item.image_filename_2 || $item.image_filename_3})<img src="({t_img_url_skin filename=icon_camera})" class="icon">({/if})<br>
({/foreach})
...
<img src="./skin/dummy.gif" alt="" style="width:14px;height:14px;" class="icon icon_1">({$item.r_datetime|date_format:"%m月%d日"})…&nbsp;<a href="({t_url m=pc a=page_fh_diary})&amp;target_c_diary_id=({$item.c_diary_id})&amp;comment_count=({$item.comment_count})">({$item.subject|t_truncate:40}) (({$item.comment_count}))</a>
({if $item.image_filename_1 || $item.image_filename_2 || $item.image_filename_3})<img src="({t_img_url_skin filename=icon_camera})" class="icon">({/if})<br>
({/foreach})
...
<img src="./skin/dummy.gif" alt="" style="width:14px;height:14px;" class="icon icon_2">({$item.r_datetime|date_format:"%m月%d日"})…&nbsp;<a href="({$item.link})" target="_blank">({$item.subject|t_truncate:40})</a><br>
({/foreach})
...
<img src="./skin/dummy.gif" alt="" style="width:14px;height:14px;" class="icon icon_3">({$item.r_datetime|date_format:"%m月%d日"})…&nbsp;<a href="({t_url m=pc a=page_h_review_list_product})&amp;c_review_id=({$item.c_review_id})">({$item.title|t_truncate:30})</a><br>
({/foreach})
