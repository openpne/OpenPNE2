...
({*********})
<tr>
<td style="width:566px;" class="bg_01" colspan="3"><img src="./skin/dummy.gif" alt="" style="width:1px;height:1px;" class="dummy"></td>
</tr>
({*********})
<tr>
...
({if $_cnt % 3 == 1})<tr>({/if})
    ...
    <td style="padding-right:1em"><label for="m({$c_friend.c_member_id})">({$c_friend.nickname})</label></td>
({if $_cnt % 3 == 0})</tr>({/if})
({/foreach})
({if $_cnt % 3 != 0})</tr>({/if})
</table>
...
({*********})
<tr>
<td style="width:566px;" class="bg_01" colspan="5"><img src="./skin/dummy.gif" alt="" style="width:1px;height:1px;" class="dummy"></td>
</tr>
({*********})
<tr>
<td class="bg_01" align="center"><img src="./skin/dummy.gif" alt="" style="width:1px;height:1px;" class="dummy"></td>
...
<textarea class="text" name="body" cols="50" rows="6"></textarea>
