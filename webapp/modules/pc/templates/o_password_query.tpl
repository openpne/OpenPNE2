...
({* #1952 *})<!-- ******ここから：パスワード確認****** -->
({* #1952 *})({t_form_block m=pc a=do_o_password_query})
...
({* #1952 *})<td style="width:458px;padding:2px 0px;" class="bg_06"><span class="b_b c_00">パスワード再発行</span></td>
...
({* #1952 *})<td style="width:634px;" class="bg_03" align="left" valign="middle">
({* #1952 *})
({* #1952 *})<div style="padding:10px 30px;">
({* #1952 *})
({* #1952 *})登録したメールアドレスと、秘密の質問・答えを入力してください。<br />
({* #1952 *})登録したものと一致すると、パスワードが登録メールアドレス宛に送信されます。
({* #1952 *})
({* #1952 *})</div>
({* #1952 *})
({* #1952 *})</td>
...
({* #1952 *})<tr>
({* #1952 *})<td style="width:1px;" class="bg_01" align="center"><img src="./skin/dummy.gif" alt="dot" class="dot"></td>
({* #1952 *})<td style="width:130px;" class="bg_05" align="left" valign="middle">
({* #1952 *})
...
({* #1952 *})<div class="padding_s">
({* #1952 *})
({* #1952 *})<select name="c_password_query_id">
({* #1952 *})<option value="" selected="selected">選択してください</option>
({* #1952 *})({foreach from=$c_password_query_list key=key item=item})
({* #1952 *})<option value="({$key})">({$item})</option>
({* #1952 *})({/foreach})
({* #1952 *})</select>
({* #1952 *})
({* #1952 *})</div>
