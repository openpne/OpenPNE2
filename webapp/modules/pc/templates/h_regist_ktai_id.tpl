...
<!-- ************************************ -->
<!-- ******ここから：プロフィール変更****** -->
({t_form m=pc a=do_h_regist_ktai_id})
...
ご利用には携帯の個体識別番号のご登録が必要となります。<br>
({if $c_member_secure.ktai_address})
携帯でログインを行い、個体識別番号のご登録を行ってください。
({else})
携帯アドレスを入力し、登録を行ってください。
({/if})
...
<input type="text" class="text" name="ktai_address" value="" size="40">
