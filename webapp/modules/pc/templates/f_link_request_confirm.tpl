...
({* #1952 *})<td style="width:528px;padding:2px 0px;" class="bg_06"><span class="b_b c_00">以下のメッセージを送信しますか？</span></td>
({* #1952 *})</tr>
({* #1952 *})</table>
({* #1952 *})<!-- ここまで：小タイトル -->
({* #1952 *})({*ここまで：header*})
...
({* #1952 *})<td style="width:564px;" class="bg_09" align="left" valign="middle" colspan="3">
({* #1952 *})
({* #1952 *})<div class="padding_w_m">
({* #1952 *})
({* #1952 *})({$target_member.nickname}) さんとは既にお知り合いですか？<br />
({* #1952 *})({$WORD_MY_FRIEND})リンク申請メッセージを送信し、承諾を受けてください。<br />
({* #1952 *})※交流の無い方へいきなりリンク申請を送るのは、失礼になる場合もあります。十分に確認して、リンク申請をおこなってください。
({* #1952 *})
({* #1952 *})</div>
({* #1952 *})
({* #1952 *})</td>
...
({* #1952 *})<div class="padding_s">
({* #1952 *})
({* #1952 *})<a href="({t_url m=pc a=page_f_home})&amp;target_c_member_id=({$target_member.c_member_id})">
({* #1952 *})<img src="({t_img_url filename=$target_member.image_filename w=76 h=76 noimg=no_image})" class="pict" /></a>
({* #1952 *})
({* #1952 *})</div>
({* #1952 *})
({* #1952 *})</td>
...
({* #1952 *})<div class="padding_s">
({* #1952 *})
({* #1952 *})<a href="({t_url m=pc a=page_f_home})&amp;target_c_member_id=({$target_member.c_member_id})">({$target_member.nickname})</a>
({* #1952 *})
({* #1952 *})</div>
({* #1952 *})
({* #1952 *})</td>
...
({* #1952 *})<td>
({* #1952 *})
({* #1952 *})<div align="center" style="text-align:center;">
({* #1952 *})
