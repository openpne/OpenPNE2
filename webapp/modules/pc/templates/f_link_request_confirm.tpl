...
({* #1931 *})<td style="width:528px;padding:2px 0px;" class="bg_06"><span class="b_b c_00">以下のメッセージを送信しますか？</span></td>
({* #1931 *})</tr>
({* #1931 *})</table>
({* #1931 *})<!-- ここまで：小タイトル -->
({* #1931 *})({*ここまで：header*})
...
({* #1931 *})<td style="width:564px;" class="bg_09" align="left" valign="middle" colspan="3">
({* #1931 *})
({* #1931 *})<div class="padding_w_m">
({* #1931 *})
({* #1931 *})({$target_member.nickname}) さんとは既にお知り合いですか？<br>
({* #1931 *})({$WORD_MY_FRIEND})リンク申請メッセージを送信し、承諾を受けてください。<br>
({* #1931 *})※交流の無い方へいきなりリンク申請を送るのは、失礼になる場合もあります。十分に確認して、リンク申請をおこなってください。
({* #1931 *})
({* #1931 *})</div>
({* #1931 *})
({* #1931 *})</td>
...
({* #1931 *})<div class="padding_s">
({* #1931 *})
({* #1931 *})<a href="({t_url m=pc a=page_f_home})&amp;target_c_member_id=({$target_member.c_member_id})">
({* #1931 *})<img src="({t_img_url filename=$target_member.image_filename w=76 h=76 noimg=no_image})" class="pict"></a>
({* #1931 *})
({* #1931 *})</div>
({* #1931 *})
({* #1931 *})</td>
...
({* #1931 *})</td>
({* #1931 *})<td style="width:1px;" class="bg_01" align="center"><img src="./skin/dummy.gif" alt="dot" class="dot"></td>
({* #1931 *})<td style="width:421px;" class="bg_02" align="left" valign="middle">
({* #1931 *})
({* #1931 *})<div class="padding_s">
({* #1931 *})
({* #1931 *})<a href="({t_url m=pc a=page_f_home})&amp;target_c_member_id=({$target_member.c_member_id})">({$target_member.nickname})</a>
({* #1931 *})
({* #1931 *})</div>
({* #1931 *})
({* #1931 *})</td>
...
({* #1931 *})<td>
({* #1931 *})
({* #1931 *})<div align="center" style="text-align:center;">
({* #1931 *})
({* #1931 *})<table border="0" cellspacing="0" cellpadding="0" style="width:100%;height:2em;">
({* #1931 *})<tr>
({* #1931 *})<td style="width:50%;text-align:right;">
({* #1931 *})({t_form_block m=pc a=do_f_link_request_insert_c_friend_confirm})
({* #1931 *})
({* #1931 *})<input type="hidden" name="target_c_member_id" value="({$target_member.c_member_id})">
({* #1931 *})<input type="hidden" name="body" value="({$form.body})">
({* #1931 *})<input type="submit" class="input_submit" value="　送　信　">&nbsp;
({* #1931 *})({/t_form_block})
({* #1931 *})</td>
({* #1931 *})<td style="width:50%;text-align:left;">
({* #1931 *})({t_form_block m=pc a=page_f_link_request})
({* #1931 *})
({* #1931 *})<input type="hidden" name="target_c_member_id" value="({$target_member.c_member_id})">
({* #1931 *})<input type="hidden" name="body" value="({$form.body})">
({* #1931 *})&nbsp;<input type="submit" class="input_submit" value="　修　正　">
({* #1931 *})({/t_form_block})
({* #1931 *})</td>
({* #1931 *})</tr>
({* #1931 *})</table>
