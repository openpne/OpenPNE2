...
({* #1931 *})<tr>
({* #1931 *})
({* #1931 *})({t_form_block m=pc a=do_fh_diary_delete_c_diary})
({* #1931 *})
({* #1931 *})<input type="hidden" name="target_c_diary_id" value="({$target_c_diary.c_diary_id})">
({* #1931 *})
({* #1931 *})<td align="right">
({* #1931 *})
...
({* #1931 *})({/t_form_block})
({* #1931 *})
({* #1931 *})({t_form_block m=pc a=page_h_diary_edit})
({* #1931 *})<input type="hidden" name="target_c_diary_id" value="({$target_c_diary.c_diary_id})">
({* #1931 *})<input type="hidden" name="target_c_member_id" value="({$target_c_diary.c_member_id})">
({* #1931 *})
({* #1931 *})<td>
({* #1931 *})
