...
<!-- ************************************ -->
<!-- ******ここから：プロフィール変更****** -->
({t_form m=pc a=page_o_regist_ktai_address_confirm})
...
<span class="b_b c_00">携帯登録用メールアドレス入力
</td>
</tr>
</table>
<!-- ここまで：小タイトル -->
...
携帯メールアドレス<span class="caution">※</span>
...
<input type="text" class="text" name="ktai_address" value="({$ktai_address})" size="40">
