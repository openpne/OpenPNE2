...
({* #1952 *})<td style="width:458px;padding:2px 0px;" class="bg_06">
({* #1952 *})<span class="b_b c_00">携帯登録用メールアドレス入力
({* #1952 *})</td>
({* #1952 *})</tr>
({* #1952 *})</table>
({* #1952 *})<!-- ここまで：小タイトル -->
...
({* #1952 *})<td style="width:636px;" class="bg_05" align="left" valign="middle">
({* #1952 *})<div style="padding:10px 30px;">
({* #1952 *})
({* #1952 *})({$smarty.const.SNS_NAME})に参加するには、携帯登録が必要です。<br />
({* #1952 *})ここで入力した携帯メールアドレス宛てに携帯登録用のURLを送信します。<br />
({* #1952 *})<br />
({* #1952 *})※ここで入力したメールアドレスは他のメンバーには公開されません<br />
({* #1952 *})※ドメイン指定受信を設定されている方は、「({$smarty.const.ADMIN_EMAIL})」からのメールを受信できるように指定してください
({* #1952 *})
({* #1952 *})</div>
({* #1952 *})</td>
...
({* #1952 *})
({* #1952 *})携帯メールアドレス<span class="caution">※</span>
({* #1952 *})
({* #1952 *})</div>
({* #1952 *})
({* #1952 *})</td>
