...
({*********})
<tr>
<td style="width:634px;height:1px;" class="bg_01" colspan="7"><img src="./skin/dummy.gif" alt="" style="width:1px;height:1px;" class="dummy"></td>
</tr>
({*********})
<tr>
<td style="width:1px;" class="bg_01" align="center"><img src="./skin/dummy.gif" alt="" style="width:1px;height:1px;" class="dummy"></td>
...
<img src="({t_img_url filename=$target_member.image_filename w=76 h=76 noimg=no_image})">
