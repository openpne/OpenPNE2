...
({* #1952 *})
({* #1952 *})({$target_c_member.nickname})さんに副管理者要請メッセージを送信します。よろしいですか。
({* #1952 *})
({* #1952 *})</div>
({* #1952 *})
({* #1952 *})</td>
...
({* #1952 *})<div class="padding_s">
({* #1952 *})
({* #1952 *})<a href="({t_url m=pc a=page_f_home})&amp;target_c_member_id=({$target_c_member.c_member_id})">
({* #1952 *})<img src="({t_img_url filename=$target_c_member.image_filename w=76 h=76 noimg=no_image})" class="pict" /></a>
({* #1952 *})
({* #1952 *})</div>
({* #1952 *})
({* #1952 *})</td>
...
({* #1952 *})<div class="padding_s">
({* #1952 *})
({* #1952 *})<a href="({t_url m=pc a=page_f_home})&amp;target_c_member_id=({$target_c_member.c_member_id})">({$target_c_member.nickname})</a>
({* #1952 *})
({* #1952 *})</div>
({* #1952 *})
({* #1952 *})</td>
