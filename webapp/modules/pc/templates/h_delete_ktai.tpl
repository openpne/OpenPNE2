...
({* #1931 *})<td align="right">
({* #1931 *})
({* #1931 *})({t_form_block m=pc a=do_h_delete_ktai})
({* #1931 *})
({* #1931 *})
...
({* #1931 *})<td>
({* #1931 *})
({* #1931 *})({t_form_block _method=get m=pc a=page_h_config_ktai})
({* #1931 *})<td>
({* #1931 *})<input type="submit" type="button"  class="input_submit" value="キャンセル">
({* #1931 *})</td>
({* #1931 *})
({* #1931 *})({/t_form_block})
({* #1931 *})
