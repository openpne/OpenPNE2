...
({* #1952 *})<!-- *ここから：スケジュール追加内容確認内容* -->
({* #1952 *})({*ここから：header*})
({* #1952 *})<!-- ここから：小タイトル -->
({* #1952 *})<table border="0" cellspacing="0" align="center" cellpadding="0" style="width:566px;" class="border_01">
({* #1952 *})<tr>
({* #1952 *})<td class="bg_06"><img src="({t_img_url_skin filename=content_header_1})" style="width: 30px;height: 20px;" class="dummy" align="left"><div class="b_b c_00" style="padding:3px 0px;">以下の内容でよろしいですか？</div>
({* #1952 *})</td>
({* #1952 *})</tr>
({* #1952 *})</table>
({* #1952 *})<!-- ここまで：小タイトル -->
...
({* #1952 *})
({* #1952 *})<table border="0" cellspacing="0" cellpadding="6" style="width:240px;">
({* #1952 *})<tr>
({* #1952 *})<td>
({* #1952 *})
({* #1952 *})({t_form_block m=pc a=do_h_schedule_add_insert_c_schedule})
({* #1952 *})
...
({* #1952 *})<input type="submit" class="input_submit" value="　 追　　加 　">
({* #1952 *})({/t_form_block})
({* #1952 *})
({* #1952 *})</td>
({* #1952 *})<td>
({* #1952 *})
({* #1952 *})({t_form_block m=pc a=page_h_schedule_add})
({* #1952 *})<input type="hidden" name="title" value="({$input.title})">
({* #1952 *})<input type="hidden" name="body" value="({$input.body})">
({* #1952 *})<input type="hidden" name="start_year" value="({$input.start_year})">
({* #1952 *})<input type="hidden" name="start_month" value="({$input.start_month})">
