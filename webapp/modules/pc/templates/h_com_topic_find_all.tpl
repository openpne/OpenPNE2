...
({*********})
<tr>
<td style="width:562px;height:1px;" class="bg_01" colspan="3"><img src="./skin/dummy.gif" alt="" style="width:1px;height:1px;" class="dummy"></td>
</tr>
({*********})
<tr>
...
({*********})
<tr>
<td style="width:634px;height:1px;" class="bg_01" colspan="3"><img src="./skin/dummy.gif" alt="" style="width:1px;height:1px;" class="dummy"></td>
</tr>
({*********})
<tr>
<td style="width:1px;" class="bg_01" align="center"><img src="./skin/dummy.gif" alt="" style="width:1px;height:1px;" class="dummy"></td>
...
({if $is_prev})
<a href="({t_url m=pc a=page_h_com_topic_find_all})&amp;direc=-1&amp;page=({$page})&amp;keyword=({$smarty.capture.keyword_url|smarty:nodefaults})&amp;type=({$search_val_list.type})">前を表示</a>&nbsp;&nbsp;
({/if})
({if $total_num})
({$start_num})件～({$end_num})件を表示
({/if})
({if $is_next})
&nbsp;&nbsp;<a href="({t_url m=pc a=page_h_com_topic_find_all})&amp;direc=1&amp;page=({$page})&amp;keyword=({$smarty.capture.keyword_url|smarty:nodefaults})&amp;type=({$search_val_list.type})">次を表示</a>
({/if})
...
({*********})
<tr>
<td style="width:550px;height:1px;" class="bg_01" colspan="9"><img src="./skin/dummy.gif" alt="" style="width:1px;height:1px;" class="dummy"></td>
</tr>
({*********})
<tr>
<td style="width:1px;" class="bg_01" align="center"><img src="./skin/dummy.gif" alt="" style="width:1px;height:1px;" class="dummy"></td>
...
<a href="({t_url m=pc a=page_c_topic_detail})&amp;target_c_commu_topic_id=({$c_topic_search.c_commu_topic_id})">
<img src="({t_img_url filename=$c_topic_search.commu_image w=76 h=76 noimg=no_logo_small})"></a>
...
({*********})
<tr>
<td style="height:1px;" class="bg_01" align="center"><img src="./skin/dummy.gif" alt="" style="width:1px;height:1px;" class="dummy"></td>
<td style="height:1px;" class="bg_01" align="center" colspan="7"><img src="./skin/dummy.gif" alt="" style="width:1px;height:1px;" class="dummy"></td>
</tr>
({*********})
<tr>
...
({*********})
<tr>
<td style="height:1px;" class="bg_01" colspan="9"><img src="./skin/dummy.gif" alt="" style="width:1px;height:1px;" class="dummy"></td>
</tr>
({*********})
</table>
<img src="./skin/dummy.gif" alt="" class="v_spacer_m">
...
({if $is_prev})
<a href="({t_url m=pc a=page_h_com_topic_find_all})&amp;direc=-1&amp;page=({$page})&amp;type=({$search_val_list.type})&amp;keyword=({$smarty.capture.keyword_url|smarty:nodefaults})">前を表示</a>&nbsp;&nbsp;
({/if})
({if $total_num})
({$start_num})件～({$end_num})件を表示
({/if})
({if $is_next})
&nbsp;&nbsp;<a href="({t_url m=pc a=page_h_com_topic_find_all})&amp;direc=1&amp;page=({$page})&amp;type=({$search_val_list.type})&amp;keyword=({$smarty.capture.keyword_url|smarty:nodefaults})">次を表示</a>
({/if})
