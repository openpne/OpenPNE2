...
<td>
<a href="({t_url _absolute=1 m=pc a=page_fh_diary})&amp;target_c_commu_id=({$c_commu.c_commu_id})" target="_blank">({$c_commu.name})</a>
</td>
</tr>
({****})
<tr>
<th>管理者</th>
<td>
<a href="({t_url _absolute=1 m=pc a=page_f_home})&amp;target_c_member_id=({$c_commu.c_member_id_admin})" target="_blank">({$c_commu.c_member.nickname})</a>
</td>
</tr>
({****})
<tr>
