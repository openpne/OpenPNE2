...
<input class="basic" type="text" name="name" value="({$item.name})" size="20" /></td>
...
<input type="hidden" name="sessid" value="({$PHPSESSID})" />
<input class="basic" type="text" name="name" value="" size="20" /></td>
...
<input class="basic" type="text" name="name" value="({$option.name})" size="20" /></td>
