...
<input type="hidden" name="a" value="do_({$hash_tbl->hash('delete_kakikomi_c_commu_selected','do')})" />
<input type="hidden" name="target_c_commu_ids" value="({$target_c_commu_ids})" />
