...
<li><a href="?m=({$module_name})&amp;a=page_({$hash_tbl->hash('delete_kakikomi')})">書き込み削除</a></li>
</ul>
</li>
...
<li><a href="?m=({$module_name})&amp;a=page_({$hash_tbl->hash('limit_domain')})">ドメイン制限</a></li>
...
<li><a href="?m=({$module_name})&amp;a=page_({$hash_tbl->hash('list_c_action')})">アクション設定</a></li>
({/if})
</ul>
</li>
