...
<font color="#({$ktai_color_config.font_01})"><a name="top">ﾒｯｾｰｼﾞの送信</a></font><br>
</td></tr></table>
...
<br>
<font color="#({$ktai_color_config.font_02})">※宛先の選択肢はﾗﾝﾀﾞﾑとなっています。送りたいﾒﾝﾊﾞｰがﾘｽﾄに表示されなかった場合、
<a href="({t_url m=ktai a=page_h_message_send})&amp;({$tail})">ここ</a>を押して画面を更新してください。</font><br>
<br>
<font color="#({$ktai_color_config.font_02})">件名：</font><br>
