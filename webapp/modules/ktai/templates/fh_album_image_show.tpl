...
<center>
<a name="pager"></a>
({if $c_album_iamge_id_prev})<a href="({t_url m=ktai a=page_fh_album_image_show})&amp;target_c_album_image_id=({$c_album_iamge_id_prev})&amp;({$tail})" accesskey="4">[i:128]前を表示</a>({/if})
({if $c_album_iamge_id_prev && $c_album_iamge_id_next})&nbsp;({/if})
({if $c_album_iamge_id_next})<a href="({t_url m=ktai a=page_fh_album_image_show})&amp;target_c_album_image_id=({$c_album_iamge_id_next})&amp;({$tail})" accesskey="6">[i:130]次を表示</a>({/if})
<br>
</center>
({/if})
