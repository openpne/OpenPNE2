...
({if $is_prev || $is_next})
<center>
({if $is_prev})<a href="({t_url m=ktai a=page_c_member_list})&amp;target_c_commu_id=({$c_commu_id})&amp;page=({$page})&amp;direc=-1&amp;({$tail})" accesskey="4">&#xE6E5;前を表示</a> ({/if})
({if $is_prev && $is_next})&nbsp;({/if})
({if $is_next})<a href="({t_url m=ktai a=page_c_member_list})&amp;target_c_commu_id=({$c_commu_id})&amp;page=({$page})&amp;direc=1&amp;({$tail})" accesskey="6">&#xE6E7;次を表示</a>({/if})
<br>
</center>
({/if})
<hr color="#0d6ddf">
