...
<font color="#({$ktai_color_config.bg_02})">◆</font><a href="({t_url m=ktai a=page_h_anataga_c_commu_member_confirm_list})&amp;({$tail})">({$WORD_COMMUNITY_HALF})要請中</a>(({$num_to_h_confirm_list|default:'0'}))<br>
