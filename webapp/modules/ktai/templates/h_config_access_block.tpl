...
<font color="#({$ktai_color_config.font_02})">ID：</font><br><input type="text" name="c_member_id_block[]" value="({$item})" istyle="4" mode="numeric"><br>
({/foreach})
<font color="#({$ktai_color_config.font_02})">ID：</font><br><input type="text" name="c_member_id_block[]" value="" istyle="4" mode="numeric"><br>
