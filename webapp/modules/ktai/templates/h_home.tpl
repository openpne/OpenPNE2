...
<img src="({t_img_url filename=$rank.image_filename w=$smarty.const.OPENPNE_IMG_KTAI_MAX_WIDTH h=$smarty.const.OPENPNE_IMG_KTAI_MAX_HEIGHT f=jpg})" alt="({$rank.name})"><br>
({/if})
