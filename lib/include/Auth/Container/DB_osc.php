 ...
 * @link       http://pear.php.net/package/Auth
 */
class Auth_Container_DB_osc extends Auth_Container
{
     ...
     */
    function Auth_Container_DB_osc($dsn)
    {
        $this->_setDefaults();
    ...
    function fetchData($username, $password, $isChallengeResponse=false)
    {
        ...
        */
        ...
        $stack = explode(':', $res[$this->options['passwordcol']]);
        
        if ($this->verifyPassword($stack[1] . $password,
                                  $stack[0],
