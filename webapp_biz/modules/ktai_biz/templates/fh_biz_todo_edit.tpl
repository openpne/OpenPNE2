...
<font color="#({$ktai_color_config.font_01})"><a name="top">Todo編集</a></font><br>
</td></tr></table>
<br>
({if $msg})
...
<font color="#({$ktai_color_config.font_02})">Todo：</font><br>
<input type="text" name='value' value="({$todo.memo})"><br>
<br>
<font color="#({$ktai_color_config.font_02})">目標期日：</font><br>
