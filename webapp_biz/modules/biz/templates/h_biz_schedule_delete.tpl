...
({* #1931 *})<td style="width:528px;padding:2px 0px;" class="bg_06"><span class="b_b c_00">本当に削除しますか？</span></td>
({* #1931 *})</tr>
({* #1931 *})</table>
({* #1931 *})<!-- ここまで：小タイトル -->
({* #1931 *})({*ここまで：header*})
...
({* #1931 *})({*********})
({* #1931 *})<tr>
({* #1931 *})<td style="width:566px;height:1px;" class="bg_01" colspan="3"><img src="./skin/dummy.gif" alt="dot" class="dot" /></td>
({* #1931 *})</tr>
({* #1931 *})({*********})
({* #1931 *})<tr>
({* #1931 *})<td style="width:1px;" class="bg_01" align="center"><img src="./skin/dummy.gif" alt="dot" class="dot" /></td>
({* #1931 *})<td style="width:564px;" class="bg_02" align="center" valign="middle">
({* #1931 *})
({* #1931 *})<div class="padding_w_m">
({* #1931 *})
({* #1931 *})<table border="0" cellspacing="0" cellpadding="2" style="width:200px;height:2em;">
({* #1931 *})<tr>
({* #1931 *})
({* #1931 *})
({* #1931 *})({t_form_block m=biz a=do_h_biz_schedule_delete})
({* #1931 *})<input type="hidden" name="schedule_id" value="({$schedule_id})" />
({* #1931 *})<input value="({$is_rep})" type="hidden" name="is_rep" />
({* #1931 *})
({* #1931 *})<td align="right">
({* #1931 *})
({* #1931 *})<input type="submit" class="submit" value=" は い " />
({* #1931 *})
({* #1931 *})</td>
({* #1931 *})
({* #1931 *})({/t_form_block})
({* #1931 *})
({* #1931 *})({t_form_block m=biz a=page_fh_biz_schedule_view})
({* #1931 *})<input type="hidden" name="id" value="({$schedule_id})" />
({* #1931 *})
({* #1931 *})<td>
({* #1931 *})
({* #1931 *})<input type="submit" class="submit" value="いいえ" />
({* #1931 *})
({* #1931 *})</td>
({* #1931 *})
({* #1931 *})({/t_form_block})
