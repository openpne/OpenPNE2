...
({*********})
<tr>
<td style="width:566px;height:1px;" class="bg_01" colspan="3"><img src="./skin/dummy.gif" alt="dot" class="dot"></td>
</tr>
({*********})
<tr>
...
({t_form m=biz a=do_h_biz_schedule_delete})
...
({t_form m=biz a=page_fh_biz_schedule_view})
