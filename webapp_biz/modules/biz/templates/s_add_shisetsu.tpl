...
({* unknown *})
({* unknown *})({t_form_block _enctype=file m=biz a=do_s_add_shisetsu})
({* unknown *})
...
({* unknown *})<div class="padding_s">
({* unknown *})
({* unknown *})<input type="text" class="text" name="name" size="50" />
({* unknown *})
({* unknown *})</div>
({* unknown *})
({* unknown *})</td>
...
({* unknown *})<div class="padding_s">
({* unknown *})
({* unknown *})<input type="text" class="text"  name="info" size="50" />
({* unknown *})
({* unknown *})</div>
({* unknown *})
({* unknown *})</td>
...
({* unknown *})<input type="submit" class="submit" value="　作　成　" />
({* unknown *})</div>
({* unknown *})
({* unknown *})</div>
({* unknown *})
