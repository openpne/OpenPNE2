...
({* #1931 *})<tr>
({* #1931 *})
({* #1931 *})({t_form_block m=biz a=do_s_delete_schedule})
({* #1931 *})<input type="hidden" name="shisetsu_id" value="({$target_id})" />
({* #1931 *})
({* #1931 *})<td align="right">
({* #1931 *})
...
({* #1931 *})({/t_form_block})
({* #1931 *})
({* #1931 *})({t_form_block _method=get m=biz a=page_s_list})
({* #1931 *})
({* #1931 *})<td>
({* #1931 *})
