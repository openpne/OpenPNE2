...
<select name='sc_b_minute'>
	...
	({section name=i loop=$mins})
		<option value="({if $mins[i] < 10 })0({/if})({$mins[i]})">({$mins[i]})分
	({/section})
</select>～
...
<input class="text" type='text' name='sc_title' size="60">
</div>
</td>
<td class="bg_01" align="center"><img src="./skin/dummy.gif" style="width:1px;height:1px;" class="dummy"></td>
</tr>
...
<textarea class="text" name='sc_memo' cols="50" rows="5"></textarea>
</div>
</td>
<td class="bg_01" align="center"><img src="./skin/dummy.gif" style="width:1px;height:1px;" class="dummy"></td>
</tr>
...
<table border="0" cellspacing="0" cellpadding="0">
<tr>
({foreach name=i from=$member_list item=item})
({if $item})
...
({else})
<td class="padding_ss" style="width:33%;" valign="top">&nbsp;</td>
({/if})
