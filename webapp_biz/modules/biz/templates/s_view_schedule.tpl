...
({* #1952 *})
({* #1952 *})<div class="padding_s">
({* #1952 *})({$schedule.date|date_format:"%Y年%m月%d日"})({$schedule.begin_time|date_format:"%H:%M"})～({$schedule.finish_time|date_format:"%H:%M"})
({* #1952 *})</div>
({* #1952 *})
({* #1952 *})</td>
({* #1952 *})<td class="bg_01" align="center"><img src="./skin/dummy.gif" alt="dot" class="dot" /></td>
...
({* #1952 *})
({* #1952 *})<table border="0" cellspacing="0" cellpadding="0" style="width:200px;height:2em;">
({* #1952 *})<tr>
({* #1952 *})({if !$msg})
({* #1952 *})<td class="padding_ss" align="center">
({* #1952 *})
({* #1952 *})({t_form_block m=biz a=page_s_delete_schedule})
({* #1952 *})<input type="hidden" name="target_id" value="({$schedule.biz_shisetsu_schedule_id})" />
({* #1952 *})<input value="削除する" type="submit" class="submit" />
({* #1952 *})({/t_form_block})
({* #1952 *})
({* #1952 *})</td>
({* #1952 *})({else})
({* #1952 *})<td class="padding_ss" align="right">
({* #1952 *})
({* #1952 *})({t_form_block m=biz a=page_s_list})
({* #1952 *})<input type="hidden" name="w" value="({$w})" />
({* #1952 *})<input value="続けて新規の施設予定登録をする" type="submit" class="submit" />
({* #1952 *})({/t_form_block})
({* #1952 *})
({* #1952 *})</td>
({* #1952 *})
({* #1952 *})({capture name="続けて予定登録"})
({* #1952 *})<td class="padding_ss" align="center">
({* #1952 *})
({* #1952 *})({t_form_block m=biz a=page_h_biz_schedule_add})
({* #1952 *})<input value="続けて予定登録をする" type="submit" class="submit" />
({* #1952 *})({/t_form_block})
({* #1952 *})
({* #1952 *})</td>
({* #1952 *})({/capture})
...
({* #1952 *})
({* #1952 *})({t_form_block m=biz a=page_s_list})
({* #1952 *})<input value="施設一覧に戻る" type="submit" class="submit" />
({* #1952 *})({/t_form_block})
({* #1952 *})
({* #1952 *})</td>
({* #1952 *})({/if})
